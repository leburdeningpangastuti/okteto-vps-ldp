...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/leburdeningpangastuti/okteto-vps-ldp/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'Alhamdulillah Wes Readyy! - Message from leburdeningpangastuti!' >/var/www/html/index.html
